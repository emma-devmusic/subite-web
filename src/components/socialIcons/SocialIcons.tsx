...
export const SocialIcons = ({color}: {color: string;}) => {
    const socialLinks = [
        {
            name: 'Facebook',
    ...
    return (
        <div className="flex sm:justify-center space-x-6 m-4 sm:m-0">
            {socialLinks.map((social) => (
                <Link
                    ...
                    className={`text-${color} hover:text-secondary`}
                >
