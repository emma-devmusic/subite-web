...
export const NewProduct = () => {
    return (
        <>
                ...
                <div className="">
                    <div className=''>
                        <div className='flex justify-between items-center mb-3'>
                            ...
                            <div className='p-3 cursor-pointer'>X</div>
                        </div>
                        <hr />
                    </div>
                    <div className='m-3'>
                        <form action="">
                            ...
                            <div className='w-100 my-4 inputImage'>
                                ...
                                <input type='text' placeholder='Arrastra o sube una imagen' className='block w-full rounded-md py-1.5 pl-7 pr-20 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-cyan-600 sm:text-sm sm:leading-6 h-[108px]' />
            ...
            <div className="bg-gray-50 px-4 py-4 sm:flex sm:flex-row sm:px-6">
