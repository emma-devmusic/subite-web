...
export const TableEDauctionsRecord = () => {
    return (
        <>
                                    ...
                                    <tr className="hover:bg-gray-100">
                                        ...
                                        <td className="p-4 flex items-center whitespace-nowrap space-x-6 mr-12 lg:mr-0">
                                            <div className="text-sm font-normal text-gray-500">
                                                <div className="text-base font-semibold text-gray-900">Terreno 15x25</div>
                                                <div className="text-sm font-normal text-gray-500">Categoría</div>
                                            </div>
                                        </td>
                                        <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">Fulano de Tal</td>
                                        <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">15/04/2024 - 17:30hs</td>
