                            ...
                            <table className="table-fixed min-w-full divide-y divide-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    <tr className="hover:bg-gray-100">
                                        ...
                                        <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">Angular</td>
                                        <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">#194556</td>
                                        <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">$149</td>
                                    ...
                                    <tr className="hover:bg-gray-100">
                                        ...
                                        <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">React JS</td>
                                        <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">#623232</td>
                                        <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">$129</td>
                                        <td className="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal" className="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                                <svg className="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fillRule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clipRule="evenodd"></path></svg>
                                                Edit item
                                    ...
                                    <tr className="hover:bg-gray-100">
                                        ...
                                        <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">Angular</td>
                                        <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">#194356</td>
                                        <td className="p-4 whitespace-nowrap text-base font-medium text-gray-900">$149</td>
                                        <td className="p-4 whitespace-nowrap space-x-2">
                                            <button type="button" data-modal-toggle="product-modal" className="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                                <svg className="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z"></path><path fillRule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clipRule="evenodd"></path></svg>
