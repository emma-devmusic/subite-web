...
export const HeaderViews = ( {breadcrumb, title, configButtons, searchBar, button}: Props ) => {
                                ...
                                <ol className="inline-flex items-center space-x-1 md:space-x-2">
                                    ...
                                    <li>
                                        <div className="flex items-center">
                                            ...
                                            <a href="#" className="text-gray-700 hover:text-gray-900 ml-1 md:ml-2 text-sm font-medium">E-commerce</a>
                                        </div>
                                    </li>
                                    <li>
                                        <div className="flex items-center">
                    ...
                    <div className="block sm:flex items-center md:divide-x md:divide-gray-100">
                        {
                            ...
                            <form className="sm:pr-3 mb-4 sm:mb-0" action="#" method="GET">
                                <label htmlFor="products-search" className="sr-only">Búsqueda</label>
                                <div className="mt-1 relative sm:w-64 xl:w-96">
                                    <input type="text" name="email" id="products-search" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Búsqueda" />
                                </div>
                            </form>
                        }
