...
export const CardCategory = ({name = 'Digital', icon, category_id = 5}: Props) => {
    ...
    return (
        <div className='rounded-lg shadow group/cardItem bg-white hover:border-primary border-[1px] p-8 transition-all hover:cursor-pointer hover:shadow-primaryLight hover:translate-y-[-1px]' onClick={() => router.push(`/auctions?categories_id=${category_id}`)}>
            <div className="flex flex-col items-center justify-center gap-4">
                <div className='text-slate-400 group-hover/cardItem:text-primary transition-all'>
                    {
