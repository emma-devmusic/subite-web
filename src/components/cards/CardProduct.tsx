...
export const CardProduct = ({ itemProduct }: Props) => {
    ...
    return (
        <div
            className="flex flex-col justify-between group/card relative rounded-lg shadow bg-white overflow-hidden"
        >
            <div>
                <div className="relative">
                    <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden bg-gray-200 lg:aspect-none group-hover/card:opacity-75 lg:h-80 relative transition-all">
