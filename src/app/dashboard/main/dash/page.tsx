                        ...
                        <ul role="list" className="divide-y divide-gray-200">
                            <li className="py-3 sm:py-4 px-2 hover:bg-gray-100 hover:cursor-pointer">
                                <div className="flex items-center space-x-4">
                                    <div className="flex-shrink-0">
                                        <img width={300} height={300} className="h-8 w-8 rounded-full" src="https://demo.themesberg.com/windster/imgs/users/neil-sims.png" alt="Neil img" />
                                    </div>
                            ...
                            <li className="py-3 sm:py-4 px-2 hover:bg-gray-100 hover:cursor-pointer">
                                <div className="flex items-center space-x-4">
                                    <div className="flex-shrink-0">
                                        <img width={300} height={300} className="h-8 w-8 rounded-full" src="https://demo.themesberg.com/windster/imgs/users/bonnie-green.png" alt="Neil img" />
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-medium text-gray-900 truncate">
                                            Bonnie Green
                            ...
                            <li className="py-3 sm:py-4 px-2 hover:bg-gray-100 hover:cursor-pointer">
                                <div className="flex items-center space-x-4">
                                    <div className="flex-shrink-0">
                                        <img width={300} height={300} className="h-8 w-8 rounded-full" src="https://demo.themesberg.com/windster/imgs/users/michael-gough.png" alt="Neil img" />
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-medium text-gray-900 truncate">
                                            Michael Gough
                            ...
                            <li className="py-3 sm:py-4 px-2 hover:bg-gray-100 hover:cursor-pointer">
                                <div className="flex items-center space-x-4">
                                    <div className="flex-shrink-0">
                                        <img width={300} height={300} className="h-8 w-8 rounded-full" src="https://demo.themesberg.com/windster/imgs/users/thomas-lean.png" alt="Neil img" />
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-medium text-gray-900 truncate">
                                            Thomes Lean
                            ...
                            <li className="py-3 sm:py-4 px-2 hover:bg-gray-100 hover:cursor-pointer">
                                <div className="flex items-center space-x-4">
                                    <div className="flex-shrink-0">
                                        <img width={300} height={300} className="h-8 w-8 rounded-full" src="https://demo.themesberg.com/windster/imgs/users/lana-byrd.png" alt="Neil img" />
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-medium text-gray-900 truncate">
                                            Lana Byrd
