...
import { TableProductsRow } from "../../products/components/TableProductsRow";
...
export default function FinishedAuctionsPage() {
    ...
    const [queryObject, setQueryObject] = useState<QueryObject>({
        pageQuerys: 'search?page=1&limit=10&with_auction=FINISHED',
        searchQuerys: ''
    });
    ...
    return (
        <div>
            <SearchBar pagesSearch={queryObject} setPagesSearch={setQueryObject} titleSearch="Subastas Finalizadas" forAuction />
